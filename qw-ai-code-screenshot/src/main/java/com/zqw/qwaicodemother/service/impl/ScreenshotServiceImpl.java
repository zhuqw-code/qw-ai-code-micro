...
import com.zqw.qwaicodemother.manager.CosManager;
import com.zqw.qwaicodemother.service.ScreenshotService;
import com.zqw.qwaicodemother.utils.WebScreenshotUtils;
...
/**
 * 因为vue项目我们需要部署后才能访问，故这个方法默认在部署后调用
 */
@Service
@Slf4j
public class ScreenshotServiceImpl implements ScreenshotService {
    ...
    private String uploadScreenshotToCos(String localScreenshotPath) {
        ...
        return cosManager.uploadToCos(cosKey, screenshotFile);
    }
